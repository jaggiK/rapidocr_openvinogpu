## rapidocr_openvino_gpu

NOTE: this is a modified version of RAPID OCR here : https://github.com/RapidAI/RapidOCR. The package is modified to support OpenVINO GPU. However, it works with only specific size. Needs to be resize with max length at 960.
